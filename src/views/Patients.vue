            ...
            >
              ...
              >
                <template v-slot:before>
                  <b-button @click="setActivePatient(editObject)" class="patients-button" variant="primary">Select Patient</b-button>
                </template>
              </view-record>
            </b-card>
          </b-card-group>
...
export default {
  ...
  created () {
    this.pageSchema = CrudRegistry.patients
    const obj = {}
  ...
  methods: {
    ...
    ...mapActions({
      setPatient: 'patient/selectPatient'
    }),
